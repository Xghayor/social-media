...
RSpec.describe Post, type: :model do
  ...
  it 'returns the most recent comments' do
    ...
    post = Post.create(author: user, title: 'testing title', text: 'hello from rspec', likes_counter: 0, comments_counter: 0 )
    ...
    comment6 = Comment.create(user: user, post: post, text: 'comment 6')
